...
<div class="container mt-4 mb-5">
    ...
    <div class="mb-3">
        ...
        <a href="generate_graduation_pdf.php" class="btn btn-maroon">📄 Generate PDF</a>
    </div>

    <div class="card">
        <div class="card-header bg-maroon">
            <h5 class="mb-0">Confirmed Graduates</h5>
        </div>
        <div class="card-body">
                ...
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge bg-primary"><?php echo $graduation_year; ?></span></td>
