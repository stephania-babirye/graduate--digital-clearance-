...
<html>
<head>
    <title>Graduation List <?php echo $settings['graduation_year']; ?></title>
    <style>
        @page {
            margin: 2cm;
        }
...
<body>
    ...
    <div class="letterhead">
        ...
        <h1><?php echo htmlspecialchars($settings['university_name']); ?></h1>
        <p class="motto">"To Serve and Build for Christ"</p>
        <p class="contact">
            P.O. Box 5498, Kampala, Uganda | 
            Tel: <?php echo htmlspecialchars($settings['university_phone']); ?> | 
            Email: <?php echo htmlspecialchars($settings['university_email']); ?>
        </p>
    </div>
    ...
    <div class="document-title">
        ...
        <div class="year">Graduation Year: <?php echo $settings['graduation_year']; ?></div>
    </div>

    <!-- Meta Information -->
    <div class="meta-info">
        <p><strong>Document Reference:</strong> UMU/REG/GRAD/<?php echo $settings['graduation_year']; ?>/<?php echo date('m'); ?></p>
    ...
    <div class="seal">
        <div class="seal-text">
            OFFICIAL SEAL<br>
            <?php echo htmlspecialchars($settings['university_name']); ?><br>
            <?php echo $settings['graduation_year']; ?>
        </div>
    </div>
